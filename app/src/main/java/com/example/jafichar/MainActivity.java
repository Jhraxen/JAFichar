...
import com.example.jafichar.Preferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFichar = findViewById(R.id.btnGuardar);
    ...
    public class MyATConsulta extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... values) {
           // coge ip, port y user de sharedpreferences
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(MainActivity.this);
            String ip = prefs.getString("etIP", " ");
            String port = prefs.getString("etPort", " ");
